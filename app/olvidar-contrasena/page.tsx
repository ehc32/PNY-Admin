...
export default async function OlvidarContrasenaPage() {
    ...
    <div className="grid min-h-svh lg:grid-cols-2">
      ...
      <div className="relative hidden lg:block">
        ...
        <div className="absolute bottom-10 left-10 z-20 text-white">
          <h3 className="text-4xl font-bold mb-2">Recupera tu acceso</h3>
          <p className="text-lg text-white/90">Te ayudaremos a restablecer tu contraseña</p>
        </div>
      </div>
    </div>
  )
